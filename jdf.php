...
// **FIXED**: این شرط از تعریف مجدد توابع و بروز خطای مرگبار جلوگیری می‌کند
// اکنون هم تابع jdate و هم تابع tr_num بررسی می‌شوند تا از تداخل با سایر افزونه‌ها جلوگیری شود.
if ( ! function_exists('jdate') && ! function_exists('tr_num') ) {
...
// **FIXED**: این آکولاد پایانی، شرطی را که در ابتدای فایل اضافه کردیم، می‌بندد
}